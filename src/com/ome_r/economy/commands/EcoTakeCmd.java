...
@Command(name = "take", aliases = "", args = "<name> <amount> ", perm = "prisoncore.economy",
			desc = "Takes money from player.", minArgs = 2, maxArgs = 2)
public class EcoTakeCmd extends CommandsHandle{
	...
	public void run(Player p, String[] args) {
		...
		EconomyResponse r = getEconomy().withdrawPlayer(pl, amount.doubleValue());
		
		if(r.transactionSuccess())
			p.sendMessage("§7" + pl.getName() + "§e's balance was debited in §7$" + getEconomy().format(amount.doubleValue()) + "§e.");
